  ...
  return (
    <footer className="bg-tertiary/30 mt-auto">
      <div className="mx-6 py-6 text-center">
        ...
        <p className="text-xs text-primary/75">&copy; {new Date().getFullYear()} Noseblind. All Rights Reserved.</p>
        <div className="flex items-center justify-center gap-3 mt-1">
          <Link
            href="/privacy"
            className="text-xs text-primary/75 hover:text-primary/70 transition-colors"
          >
            Privacy Policy
          </Link>
